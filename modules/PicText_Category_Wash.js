...
angular.module('app.wash', [])
    .controller('WashController', ['$scope', 'ResourceManager', 'ActivityManager', 'COMMON_KEYS','BtnService','MenuService', function ($scope, ResourceManager, ActivityManager, COMMON_KEYS,BtnService,MenuService) {
        ...
        function borderAnimate(key){
            ...
            switch (key) {
                case 0:
                    ...
                    $(".submit-btn").removeClass("un-selected")
                    $(".time-btn").addClass("un-selected");
                    break;
                case 1:
                ...
                case 2:
                    ...
                    $(".time-btn").removeClass("un-selected")
                    $(".submit-btn").addClass("un-selected");
                    break;
            }
        }
        ...
        function dealTime(t){
            ...
            $scope.timeStr = $scope.year + "/" + timeArray[0] + "/" + timeArray[1] + ' ' + timeArray[2] + ':' + timeArray[3];
